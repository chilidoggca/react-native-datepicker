...
class DatePicker extends Component {
  ...
  getTitleElement() {
    const { date, locale, placeholder, customStyles, allowFontScaling } = this.props;
    let dateStr = format === 'hh:mm a' ? this.getDateStr() : Moment(this.getDate()).locale(locale).format(format)
